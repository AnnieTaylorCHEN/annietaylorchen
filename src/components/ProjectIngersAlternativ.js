        ...
        <>
            <section className="project-grid">
                <div className="project-intro">
                    ...
                    <p className="project-text">Ingers Alternativ is a website for a therapist from Stockholm. This is my very first commercial web project that’s built from scratch, with hand made HTML and CSS designed and written by me, before I started to learn Javascript.</p>
                </div>
                ...
                <div className="demo-code">
                    <a className="demo-code--button" href="https://ingersalternativ.se/" target="_blank" rel="noopener noreferrer">LIVE DEMO</a>
                </div> 
            </section>
            ...
            <section className="inger-grid">
                <div className="inger-rebrand">
                    ...
                    <p className="project-text">The previous site was a very simple Wordpress site with zero branding concept. I wanted to help the client build a strong brand that reflects her business core, which offers valuable information to her customers. We spent a lot of time discussing the business goal, unique selling point, SWOT analysis as well as creating persona. I guided my client through all the process to help her write what we were going to put online.</p>
                </div>

                <div className="rebrandimg">
                    <img src="/imgs/ingers-rebrandimg.jpg" alt="blur background of Ingers Alternativ preparation plan" />
                </div>

                <div className="inger-senior">
                    <h4 className="context-subtitle">Design for seniors</h4>
                    <p className="project-text">We decided to use a calm muted green as branding color, as it is related to the core business – therapies and meditation. The design is made for seniors, so everything is slightly bigger than average. I hand picked beautiful images to add visual aid to the content.</p>
                    <p className="project-text">The client is a senior person with limited technical skills and time, so we decided not to go full range when it comes to social media marketing. </p>
                </div>
                ...
                <iframe title="Ingers Alternativ reklam" width="100%" height="700px" src="https://www.youtube.com/embed/d5Nsktdv1SM" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>

                <div className="inger-videotext">
                    <p className="project-text">We had a limited budget, but I managed to squeeze a promo video that was made from open source footage and the ones I shot myself.</p>
                 </div>
                ...
                <div className="inger-card">
                    <div className="inger-old-card">
                        <img src="/imgs/inger-old-card.jpg" alt="Inger's old business card" />
                        <div className="before">before</div>
                    </div>
                    <div>
                        <img src="/imgs/inger-new-card.jpg" alt="Inger's new business card" />
                        <div className="after">after</div>
                    </div>
                </div>            
            </section>
