...
const devToolsData = [
  ...
  },
  {
    ...
    name: "Pine Tools",
    description:
      "Free online tools for every situation, work with text (reverse, convert to uppercase or lowercase), images (invert, resize, crop), lists (sort in alphabetical order, ... ",
  ...
  },
  {
    ...
    name: "CSSMatic",
    description:
      "Gradient, Border Radius, Noise Texture, Text-Shadow generator.",
  ...
  },
  {
    ...
    description:
      "About Clip Paths. The clip-path property allows you to make complex shapes in CSS by clipping an element to a basic shape (circle, ellipse, polygon, or inset).",
