...
export default function MenuModal({ handleMenuClick, menuVisibility }) {
  let visibility = "hide";
  ...
  return (
    <div id="menu-modal__container" className={visibility}>
      <button className="menu-model__close" onClick={() => handleMenuClick()}>
        &times;
      </button>
