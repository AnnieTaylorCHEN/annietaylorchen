...
const csData = [
  {
    ...
    description: 'This webpage covers the space and time Big-O complexities of common algorithms used in Computer Science. ',
    url: 'https://www.bigocheatsheet.com/',
  },
  {
    img: '/imgs/resources/visualgo.jpg',
    name: 'VisuAlgo',
    description: 'VisuAlgo was conceptualised in 2011 by Dr Steven Halim as a tool to help his students better understand data structures and algorithms.',
  ...
  },
  {
    ...
    name: 'Hacker Rank',
    description: 'Join over 7 million developers. Practice coding, prepare for interviews, and get hired.',
