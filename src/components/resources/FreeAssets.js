...
const freeAssetsData = [
  ...
  },
  {
    ...
    name: "Pexels",
    description:
      "Free stock photos and videos you can use everywhere. ✓ Free for commercial use ✓ No attribution required.",
  ...
  },
  {
    ...
    name: "Pixabay",
    description:
      "Free photos, illustrations, vectors, video and music. Note some resources might be amateurish.",
  ...
  },
  {
    ...
    name: "Videvo",
    description:
      "Free stock video footage with over 28000 video clips in 4k and HD. Quality is a bit amateurish.",
  ...
  },
  {
    ...
    name: "Mixkit",
    description:
      "Free Stock Video Footage, Stock Music & Premiere Pro Templates for your next video editing project. All royalty free assets are completely free!",
    url: "https://mixkit.co/",
  },
  {
    ...
    name: "Free Sound",
    description:
      "Freesound is a collaborative repository of CC licensed audio samples, and non-profit organisation, with more than 400,000 sounds and effects, and 8 million registered users. ",
  ...
  },
  {
    ...
    name: "humaaans",
    description:
      "Mix-&-match illustrations of people with a design library. Free for commercial or personal use by Pablo Stanley. ",
  ...
  },
  {
    ...
    name: "Icon Monsters",
    description:
      "iconmonstr - free, monstrously big and continuously growing source of simple icons run by Alexander Kahlkopf.",
  ...
  },
  {
    ...
    description:
      "The largest collection of free and premium Sketch resources for mobile, web, UI, and UX designers working with Sketch by Bohemian Coding.",
