          ...
          <div
            ...
            <div className="layer bottom">
              <div className="content-wrap">
                ...
                <img src="/imgs/profile/annie-coding.png" alt="Annie Taylor CHEN - full-stack developer" />
              </div>
            </div>
            ...
            <div className="layer top" style={{width: mouseMove.topLayerWidth }}>
              <div className="content-wrap">
                ...
                <img src="/imgs/profile/annie-on-the-moon.png" alt="Annie Taylor CHEN - photographer" />
              </div>
            </div>
